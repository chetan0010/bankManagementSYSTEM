...
{
    cout << "\nGreetings You are welcome to our Bank\n";
    cout << "\nEnter The Account Number : ";
    cin >> acc_no;
    while (cin.fail()) // Not an int value
    {
    ...
    cout << "\nEnter Type of The Account *Current or *Saving (C/S) (Default Will Be Saving) :- ";
    cin >> type;
    ...
    type = toupper(type);
    cin.ignore();
    cout << "\nEnter the Initial amount (greater than 1000 for Saving and greater than 2000 for current) : ";
    cin >> deposit;
