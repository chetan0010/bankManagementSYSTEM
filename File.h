...
// Here data present in class object acc is written to file details.dat by calling write function.
...
void write_account()
{
    ...
    infile.open("details.dat", ios::binary | ios::in);
...
void modify_account(int n)
{
    ...
    vj.open("details.dat", ios::binary | ios::in | ios::out);
...
void delete_account(int n)
{
    ...
    infile.close();
    outfile.close();
    remove("details.dat");             // Delete a File from Current Directory
    rename("Temp.dat", "details.dat"); // Changes the name of the file or directory specified by oldname to newname.
